"""
Django settings for holder_sitemonitor_45843 project.
...
ROOT_URLCONF = 'holder_sitemonitor_45843.urls'
...
WSGI_APPLICATION = 'holder_sitemonitor_45843.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "holder_sitemonitor_45843 API",
    "DESCRIPTION": "API documentation for holder_sitemonitor_45843 App",
    "VERSION": "v1",
}
